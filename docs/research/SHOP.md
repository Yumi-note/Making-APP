...
Shopify Inc.（SHOP）はCanadaを主な事業基盤とするTechnologyセクターの企業で、市場区分はUSです。業種はSoftware - Applicationに属し、時価総額は147.58B、従業員規模は約7,600名です。
...
- PER基準(US): 15以下が割安目安。PER 111.50 は割高寄り。配当データなし。
...
- [当日の銘柄レポート](../reports/2026-06-16/192404/SHOP.md)
