...
Uber Technologies, Inc.（UBER）はUnited Statesを主な事業基盤とするTechnologyセクターの企業で、市場区分はUSです。業種はSoftware - Applicationに属し、時価総額は140.28B、従業員規模は約35,000名です。
...
- PER基準(US): 15以下が割安目安。PER 17.10 は中立。配当データなし。
...
- [当日の銘柄レポート](../reports/2026-07-23/170716/UBER.md)
