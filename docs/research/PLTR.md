...
Palantir Technologies Inc.（PLTR）はUnited Statesを主な事業基盤とするTechnologyセクターの企業で、市場区分はUSです。業種はSoftware - Infrastructureに属し、時価総額は303.96B、従業員規模は約4,395名です。
...
- PER基準(US): 15以下が割安目安。PER 142.46 は割高寄り。配当データなし。
...
- [当日の銘柄レポート](../reports/2026-07-11/163928/PLTR.md)
