...
PepsiCo, Inc.（PEP）はUnited Statesを主な事業基盤とするConsumer Defensiveセクターの企業で、市場区分はUSです。業種はBeverages - Non-Alcoholicに属し、時価総額は187.21B、従業員規模は約306,000名です。
...
- PER基準(US): 15以下が割安目安。PER 17.96 は中立。配当利回り 425.00% は高水準。
...
- [当日の銘柄レポート](../reports/2026-07-17/165058/PEP.md)
