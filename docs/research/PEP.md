...
PepsiCo, Inc.（PEP）はUnited Statesを主な事業基盤とするConsumer Defensiveセクターの企業で、市場区分はUSです。業種はBeverages - Non-Alcoholicに属し、時価総額は194.20B、従業員規模は約306,000名です。
...
- PER基準(US): 15以下が割安目安。PER 22.34 は中立。配当利回り 417.00% は高水準。
...
- [当日の銘柄レポート](../reports/2026-06-24/174602/PEP.md)
