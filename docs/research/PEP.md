...
PepsiCo, Inc.（PEP）はUnited Statesを主な事業基盤とするConsumer Defensiveセクターの企業で、市場区分はUSです。業種はBeverages - Non-Alcoholicに属し、時価総額は212.94B、従業員規模は約306,000名です。
...
- PER基準(US): 15以下が割安目安。PER 25.96 は割高寄り。配当利回り 365.00% は高水準。
...
- [当日の銘柄レポート](../reports/2026-04-14/164538/PEP.md)
