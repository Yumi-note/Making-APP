...
Oracle Corporation（ORCL）はUnited Statesを主な事業基盤とするTechnologyセクターの企業で、市場区分はUSです。業種はSoftware - Infrastructureに属し、時価総額は529.57B、従業員規模は非開示です。
...
- PER基準(US): 15以下が割安目安。PER 31.53 は割高寄り。配当利回り 109.00% は高水準。
...
- [当日の銘柄レポート](../reports/2026-06-13/170606/ORCL.md)
