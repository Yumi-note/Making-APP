...
Oracle Corporation（ORCL）はUnited Statesを主な事業基盤とするTechnologyセクターの企業で、市場区分はUSです。業種はSoftware - Infrastructureに属し、時価総額は545.14B、従業員規模は非開示です。
...
- PER基準(US): 15以下が割安目安。PER 32.46 は割高寄り。配当利回り 104.00% は高水準。
...
- [当日の銘柄レポート](../reports/2026-06-16/192404/ORCL.md)
