...
Spotify Technology S.A.（SPOT）はSwedenを主な事業基盤とするCommunication Servicesセクターの企業で、市場区分はUSです。業種はInternet Content & Informationに属し、時価総額は102.17B、従業員規模は約7,000名です。
...
- PER基準(US): 15以下が割安目安。PER 27.06 は割高寄り。配当データなし。
...
- [当日の銘柄レポート](../reports/2026-08-13/163423/SPOT.md)
