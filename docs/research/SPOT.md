...
Spotify Technology S.A.（SPOT）はSwedenを主な事業基盤とするCommunication Servicesセクターの企業で、市場区分はUSです。業種はInternet Content & Informationに属し、時価総額は104.48B、従業員規模は約7,000名です。
...
- [当日の銘柄レポート](../reports/2026-09-24/193035/SPOT.md)
