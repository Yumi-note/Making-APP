...
Netflix, Inc.（NFLX）はUnited Statesを主な事業基盤とするCommunication Servicesセクターの企業で、市場区分はUSです。業種はEntertainmentに属し、時価総額は372.36B、従業員規模は約16,000名です。
...
- PER基準(US): 15以下が割安目安。PER 28.53 は割高寄り。配当データなし。
...
- [当日の銘柄レポート](../reports/2026-05-07/172931/NFLX.md)
