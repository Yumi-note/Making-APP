...
Cisco Systems, Inc.（CSCO）はUnited Statesを主な事業基盤とするTechnologyセクターの企業で、市場区分はUSです。業種はCommunication Equipmentに属し、時価総額は437.66B、従業員規模は非開示です。
...
- PER基準(US): 15以下が割安目安。PER 33.35 は割高寄り。配当利回り 151.00% は高水準。
...
- [当日の銘柄レポート](../reports/2026-08-22/160856/CSCO.md)
