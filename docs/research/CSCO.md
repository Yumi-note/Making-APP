...
Cisco Systems, Inc.（CSCO）はUnited Statesを主な事業基盤とするTechnologyセクターの企業で、市場区分はUSです。業種はCommunication Equipmentに属し、時価総額は431.19B、従業員規模は非開示です。
...
- PER基準(US): 15以下が割安目安。PER 32.85 は割高寄り。配当利回り 152.00% は高水準。
...
- [当日の銘柄レポート](../reports/2026-09-01/185523/CSCO.md)
