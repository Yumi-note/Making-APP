...
International Business Machines Corporation（IBM）はUnited Statesを主な事業基盤とするTechnologyセクターの企業で、市場区分はUSです。業種はInformation Technology Servicesに属し、時価総額は209.78B、従業員規模は約264,300名です。
...
- PER基準(US): 15以下が割安目安。PER 19.77 は中立。配当利回り 304.00% は高水準。
...
- [当日の銘柄レポート](../reports/2026-05-20/180801/IBM.md)
