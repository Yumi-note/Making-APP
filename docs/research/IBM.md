...
International Business Machines Corporation（IBM）はUnited Statesを主な事業基盤とするTechnologyセクターの企業で、市場区分はUSです。業種はInformation Technology Servicesに属し、時価総額は224.75B、従業員規模は約264,300名です。
...
- PER基準(US): 15以下が割安目安。PER 21.19 は中立。配当利回り 289.00% は高水準。
...
- [当日の銘柄レポート](../reports/2026-08-21/160402/IBM.md)
