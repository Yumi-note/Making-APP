...
PayPal Holdings, Inc.（PYPL）はUnited Statesを主な事業基盤とするFinancial Servicesセクターの企業で、市場区分はUSです。業種はCredit Servicesに属し、時価総額は39.25B、従業員規模は約23,800名です。
...
- PER基準(US): 15以下が割安目安。PER 8.35 は割安寄り。配当利回り 126.00% は高水準。
...
- [当日の銘柄レポート](../reports/2026-05-21/174858/PYPL.md)
