...
Apple Inc.（AAPL）はUnited Statesを主な事業基盤とするTechnologyセクターの企業で、市場区分はUSです。業種はConsumer Electronicsに属し、時価総額は4.56T、従業員規模は約166,000名です。
...
- PER基準(US): 15以下が割安目安。PER 37.62 は割高寄り。配当データなし。
...
- [当日の銘柄レポート](../reports/2026-06-03/193627/AAPL.md)
