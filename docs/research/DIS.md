...
The Walt Disney Company（DIS）はUnited Statesを主な事業基盤とするCommunication Servicesセクターの企業で、市場区分はUSです。業種はEntertainmentに属し、時価総額は169.20B、従業員規模は約175,560名です。
...
- PER基準(US): 15以下が割安目安。PER 15.59 は中立。配当利回り 151.00% は高水準。
...
- [当日の銘柄レポート](../reports/2026-07-06/180158/DIS.md)
