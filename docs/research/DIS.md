...
The Walt Disney Company（DIS）はUnited Statesを主な事業基盤とするCommunication Servicesセクターの企業で、市場区分はUSです。業種はEntertainmentに属し、時価総額は181.59B、従業員規模は約175,560名です。
...
- PER基準(US): 15以下が割安目安。PER 16.73 は中立。配当利回り 141.00% は高水準。
...
- [当日の銘柄レポート](../reports/2026-05-13/175058/DIS.md)
