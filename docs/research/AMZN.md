...
Amazon.com, Inc.（AMZN）はUnited Statesを主な事業基盤とするConsumer Cyclicalセクターの企業で、市場区分はUSです。業種はInternet Retailに属し、時価総額は3.01T、従業員規模は約1,595,000名です。
...
- PER基準(US): 15以下が割安目安。PER 21.46 は中立。配当データなし。
...
- [当日の銘柄レポート](../reports/2026-08-04/172441/AMZN.md)
