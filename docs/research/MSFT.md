...
Microsoft Corporation（MSFT）はUnited Statesを主な事業基盤とするTechnologyセクターの企業で、市場区分はUSです。業種はSoftware - Infrastructureに属し、時価総額は3.16T、従業員規模は約228,000名です。
...
- PER基準(US): 15以下が割安目安。PER 26.59 は割高寄り。配当利回り 86.00% は高水準。
...
- [当日の銘柄レポート](../reports/2026-04-25/162317/MSFT.md)
