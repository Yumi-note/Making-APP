...
Zoom Communications, Inc.（ZM）はUnited Statesを主な事業基盤とするTechnologyセクターの企業で、市場区分はUSです。業種はSoftware - Applicationに属し、時価総額は25.08B、従業員規模は約7,438名です。
...
- PER基準(US): 15以下が割安目安。PER 13.70 は割安寄り。配当データなし。
...
- [当日の銘柄レポート](../reports/2026-04-08/164653/ZM.md)
